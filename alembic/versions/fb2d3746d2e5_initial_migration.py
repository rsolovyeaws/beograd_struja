...
Revision ID: fb2d3746d2e5
Revises: 244791ccb0fc
Create Date: 2024-11-23 12:36:47.523149
...
revision: str = 'fb2d3746d2e5'
down_revision: Union[str, None] = '244791ccb0fc'
...
def upgrade() -> None:
    ...
    sa.Column('bot_language', sa.String(length=100), nullable=True),
    sa.PrimaryKeyConstraint('id')
    )
