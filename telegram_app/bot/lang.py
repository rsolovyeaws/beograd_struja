"""Module containing language phrases and actions for the Telegram bot."""
...
PHRASES = {
    "Serbian": {
        ...
        "enter_area": "Молимо вас да унесете вашу област Београда (нпр. земун)",
        ...
        "invalid_area": "Невалидан унос. Унесите валидну област.",
        "invalid_address": "Невалидна адреса. Покушајте поново.",
    ...
    "English": {
        ...
        "enter_area": "Please enter your area of the Belgrade (e.g., Земун)",
        ...
        "invalid_area": "Invalid input. Please enter a valid area.",
    ...
    "Russian": {
        ...
        "enter_area": "Пожалуйста, введите ваш район Белграда (например, Земун):",
        ...
        "invalid_area": "Неверный ввод. Пожалуйста, введите действительный район.",
        "invalid_address": "Неверный адрес. Пожалуйста, попробуйте еще раз.",
